...
#--------- Head Contours Color, Line Contours for phi, Dashed iso lines for psi    
        ...
        contour1 = plt.contourf (Z_real, Z_imag, head_complex_real, 201, cmap=cm.GnBu, alpha=1, zorder = 1) #cm.Blues
        contour2 = plt.contour (Z_real, Z_imag, discharge_potential, levels= 65, colors = 'white', 
...
#-------Streamplot
        ...
        #     linewidth=1.6, density=(1, 1.2), arrowsize=1.75, color='#FFA500' ,zorder=4)   #  cmap=cm.PRGn
...
#--------- Head Contours Color, Line Contours for phi, Dashed iso lines for psi    
        ...
        contour1 = plt.contourf (Z_real, Z_imag, head_real, 80, cmap=cm.GnBu, alpha=1, zorder = 1) #cm.Blues
        contour2 = plt.contour (Z_real, Z_imag, discharge_potential, levels= 65, colors = 'white', linestyles='dashed', zorder=2 ) # correct phi base with phi  gist_rainbow
        plt.colorbar(contour1, shrink = 0.7, label= ' Head (m) ')
        
        contour3 = plt.contour(Z_real, Z_imag, stream_fxn, levels=500, 
            cmap=cm.Wistia,
            linestyles='solid' ,zorder=3)
        contour2.changed()
...
#--------- Head Contours Color, Line Contours for phi, Dashed iso lines for psi    
        cmr_corlormap= cmr.ocean
        contour1 = plt.contourf (Z_real, Z_imag, head_real, 100, cmap=cm.GnBu, alpha=1, zorder = 1) #cm.Blues, cmap=cmr_corlormap
        contour2 = plt.contour (Z_real, Z_imag, head_real, levels= 55, colors = 'black', linewidth=10, linestyles='dashed', zorder=2) # correct phi base with phi  gist_rainbow
        plt.colorbar(contour1, shrink = 0.7, label= ' Head (m) ')
        ax.clabel(contour2, inline=True, fontsize=17)
        # contour3 = plt.contour(Z_real, Z_imag, stream_fxn, levels=250, cmap=cm.Wistia, linestyles='solid' ,zorder=3)
        # contour2.changed()
        # labels = ['Streamline', 'Potentialline']
...
#--------- Head Contours Color, Line Contours for phi, Dashed iso lines for psi    
        cmr_corlormap= cmr.ocean
        contour1 = plt.contourf (Z_real, Z_imag, head_real, 65, cmap=cm.GnBu, alpha=1, zorder = 1) 
        contour2 = plt.contour (Z_real, Z_imag, discharge_potential, levels= 40, colors = 'white', linewidth=10, linestyles='dashed', zorder=2) 
        plt.colorbar(contour1, shrink = 0.7, label= ' Head (m) ')
...
#--------- Head Contours Color, Line Contours for phi, Dashed iso lines for psi    
        ...
        contour2 = plt.contour (Z_real, Z_imag, discharge_potential, levels= 65, colors = 'white', linewidth=10, linestyles='dashed', zorder=2) 
        plt.colorbar(contour1, shrink = 0.7, label= ' Head (m) ')
